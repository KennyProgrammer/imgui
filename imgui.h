...
#define FE_IMGUI_C0001 1  // 1 == enable custom ImGuiConfigFlags_DisableCtrlTabWindowSelection, 0, disale it.
...
#if FE_IMGUI_C0001
    // #FE_IMGUI_C0001: [BETA] Disable CTRL+TAB/Square+L/R window selection menu.
    ImGuiConfigFlags_DisableCtrlTabWindowSelection = 1 << 22
#endif
};
